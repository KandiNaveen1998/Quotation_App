...
import PaymentLinkedAmount from './PaymentLinkedAmount';
...
export default function PaymentForm() {
    ...
    return (
        <>
            <Heading name="Create Payment " showBack={true} />
            <ScrollView>
                    ...
                    <View style={CommonStyles.mainBlock}>
                        <View style={styles.dateRow}>
                            ...
                            < FormInput
                                label="Payment No"
                                name="paymentNo"
                                onChange={(e: string) => handleInputChange(e, 'paymentNo', 'string')}
                            ...
                            <FormDate
                                ...
                                onDateChange={(selectedDate) => {
                                    handleInputChange(selectedDate, 'paymentDate', 'string');
                                }}
                            />
                        </View>
                    </View>
