...
import ReceiptLinkedAmount from '../Receipt/ReceiptLinkedAmount';
import TabLinkPayment from './TabLinkPayments';


export default function LinkedPaymentForm() {
    ...
    return (
        <>
            <Heading name="Create Link Payment " showBack={true} />
            <ScrollView>
                <FormProvider {...methods}>
                    ...
                    <View style={CommonStyles.mainBlock}>
                        ...
                        < FormInput
                            label="Link Payment"
                            name="linkPayment"
                            onChange={(e: string) => handleInputChange(e, 'linkPayment', 'string')}
                            style={CommonStyles.miniInput}
                            secureTextEntry={false}
                            keyboardType="default"
                            control={control}
